...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
        ...
        const CITY_COORDS = {
            ...
            "arlington": [38.8786, -77.1008],
            "fairfax": [38.8462, -77.3064],
            "reston": [38.9586, -77.3578],
            "richmond": [37.5407, -77.4360],
            "baltimore": [39.2904, -76.6122],
            "annapolis": [38.9784, -76.4922],
            "bethesda": [38.9847, -77.1131],
        ...
        const AMERICAN_AIRPORTS = [
            { code: 'IAD', name: 'Washington Dulles International Airport (IAD)', city: 'Chantilly, VA', coords: [38.9531, -77.4565] },
            { code: 'DCA', name: 'Ronald Reagan Washington National Airport (DCA)', city: 'Arlington, VA', coords: [38.8512, -77.0377] },
